...
<body>
  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
    <div class="container-fluid">
      <a class="navbar-brand" href="#">Class 10</a>
...
<?php
 if ($_SERVER['REQUEST_METHOD'] == 'POST'){
    ...
    if($per>50){
     ...
     $sql = "INSERT INTO `class` (`rollno`, `name`, `divi`, `English`, `Hindi`, `Marathi`, `Totallmarks`, `percentage`, `result`) VALUES ('$rollno', '$name', '$div', '$engm', '$hinm', '$marm', '$totall', '$per', '$result')";
...
<div class="forms">  
  <form class="navbar-form container my-5" Method="post" action="<?php $_SERVER['SERVER_NAME']; ?>">
    ...
    <div class="mb-3">
      <input type="VARCHAR" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp"
        placeholder="DIV" 2 name="div">
    </div>
    ...
    <div class="row">
      ...
      <div class="col">
        ...
        <div class="form-outline">
          <input type="number" id="form8Example3" class="form-control" name="engm" />
      ...
      <div class="col">
        <!-- Name input -->
        <div class="form-outline">
          <input type="number" id="form8Example4" class="form-control" name="hinm" />
      ...
      <div class="col">
        <!-- Email input -->
        <div class="form-outline">
          <input type="number" id="form8Example5" class="form-control" name="marm" />
